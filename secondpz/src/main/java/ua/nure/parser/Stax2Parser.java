...
public class Stax2Parser {
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<Film> films = parser.parse(new FileInputStream(Const.XML_FILE), Const.XSD_FILE);
        System.out.println("====================================");
        System.out.println("Here is the films: \n" + films);
        System.out.println("====================================");
		films = parser.parse(new FileInputStream(Const.INVALID_XML_FILE), Const.XSD_FILE);
        System.out.println("====================================");
        System.out.println("Here is the invalid films: \n" + films);
        System.out.println("====================================");
    }

    private List<Film> parse(InputStream in, String schemaFile) throws XMLStreamException {
