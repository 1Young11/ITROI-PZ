...
import film.dao.dbtable.DBTable;
import film.dao.dbtable.DBTableFactory;
import film.dao.dbtable.Filter;
import film.entity.Film;
import film.entity.Ticket;
import film.entity.Viewer;
...
public class FilmDAOInMemoryImpl implements FilmDAO {
    ...
    public void addTicket(Ticket ticket) {
        Film film = null;
        try {
            film = this.films.get(ticket.getFilmId());
            film.getTicket().add(ticket);
            this.films.update(ticket.getFilmId(), film);
