...
import film.service.App;
import film.service.Constants;
...
public class AppServer {
    ...
    public static void main(String[] args) throws InterruptedException, IOException, URISyntaxException {
        System.out.println("\"Films\" Jersey Example Application");
        ...
        System.out.println("Application started.\n"
                + "Try accessing " + getBaseURI(Constants.BASE_URI, Constants.PORT, Constants.APPLICATION_PATH, Constants.FILMS_SERVICE_PATH) +" in the browser.\n");
