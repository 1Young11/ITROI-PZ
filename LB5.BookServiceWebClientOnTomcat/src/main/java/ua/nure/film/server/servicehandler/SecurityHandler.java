package ua.nure.film.server.servicehandler;//package ua.nure.article.server.servicehandler;
//
...
//	private static final String CLIENT_TOKEN_NAME = "clientToken";
//	private static final QName CLIENT_TOKEN_QNAME = new QName(Const.SERVICE_NS, CLIENT_TOKEN_NAME);
//
//	private static final String SERVICE_TOKEN_NAME = "serviceToken";
//	private static final QName SERVICE_TOKEN_QNAME = new QName(Const.SERVICE_NS, SERVICE_TOKEN_NAME);
//
//	private final JAXBContext jaxb;
//
//	public SecurityHandler() {
//		try {
//			jaxb = JAXBContext.newInstance("ua.nure.article.server.service");
...
//			marshaller.marshal(new JAXBElement<String>(CLIENT_TOKEN_QNAME, String.class, CLIENT_TOKEN), header);
//			message.saveChanges();
//			log.info("Client token: {}", toString(header));
...
//			jakarta.xml.soap.Node childElements = header.getChildElements(SERVICE_TOKEN_QNAME).next();
//			JAXBElement<String> sh = unmarshaller.unmarshal(childElements, String.class);
//			return isValidToken(sh.getValue());
//		} catch (Exception e) {
//			String faultString = "Service token not found";
